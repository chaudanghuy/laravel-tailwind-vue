  ...
  <div class="container">
    ...
    <div class="directory-active">
      ...
      <div class="properties pb-20">
        <div class="properties__card">
          <div class="properties__img overlay1">
            <a href="#"><img src="/src/assets/img/gallery/properties1.png" alt=""></a>
            <div class="img-text">
              <span>$</span>
              <span>Closed</span>
            </div>
            <div class="icon">
              <img src="/src/assets/img/gallery/categori_icon1.png" alt="">
            </div>
          </div>
          ...
          <div class="properties__footer d-flex justify-content-between align-items-center">
            <div class="restaurant-name">
              <img src="/src/assets/img/gallery/restaurant-icon.png" alt="">
              <h3>Food & Restaurant</h3>
            </div>
            <div class="heart">
              <img src="/src/assets/img/gallery/heart1.png" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="properties pb-20">
        <div class="properties__card">
          <div class="properties__img overlay1">
            <a href="#"><img src="/src/assets/img/gallery/properties2.png" alt=""></a>
            <div class="img-text">
              <span>$</span>
              <span>Closed</span>
            </div>
      ...
      <div class="properties pb-20">
        <div class="properties__card">
          <div class="properties__img overlay1">
            <a href="#"><img src="/src/assets/img/gallery/properties3.png" alt=""></a>
            <div class="img-text">
              <span>$</span>
              <span>Closed</span>
            </div>
